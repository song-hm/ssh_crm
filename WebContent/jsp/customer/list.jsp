											...
											<TBODY>
												<TR>
													...
													<td><s:textfield name="custName" class="textbox"
															id="sChannel2" style="WIDTH: 80px" maxLength="50"></s:textfield>
													</td>
													<td>所属行业 ：</td>
													...
													<td>信息来源 ：</td>
													<td><s:select name="custSource.dictId" list="custSources" listKey="dictId" listValue="dictItemName" headerKey="" headerValue="---请选择---" class="textbox" id="sChannel2"
															style="WIDTH: 80px"></s:select></td>
													<td>客户级别：</td>
													<td><s:select name="custLevel.dictId" list="custLevels" listKey="dictId" listValue="dictItemName" headerKey="" headerValue="---请选择---" class="textbox" id="sChannel2"
															style="WIDTH: 80px"></s:select></td></td>																								
												   <TD><s:submit value="筛选"></s:submit> </TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
