					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<TR>
								<td>客户名称：</td>
								<td>
									<s:textfield name="custName" class="textbox" id="sChannel2" style="WIDTH: 180px" maxLength="50" ></s:textfield>									
								</td>
								<td>所属行业 ：</td>
								<td>
									<s:textfield name="custIndustry" class="textbox" id="sChannel2" style="WIDTH: 180px" maxLength="50" ></s:textfield>																		
								</td>
							</TR>							
							<TR>	
								<td>信息来源 ：</td>
								...
								<td>
									<select name="custLevel.dictId" class=textbox id=sChannel2 style="WIDTH: 180px">
										...
										<s:iterator value="custLevels">
											<option value="${dictId}" ${custLevel.dictId==dictId?"selected":"" }>${dictItemName}</option>
										</s:iterator>
									</select>								
								</td>
							</TR>
							<TR>
								<td>联系地址 ：</td>
								<td>
									<s:textfield name="custAddress" class="textbox" id="sChannel2" style="WIDTH: 180px" maxLength="50" ></s:textfield>																			
								</td>
								<td>联系电话 ：</td>
								<td>
									<s:textfield name="custPhone" class="textbox" id="sChannel2" style="WIDTH: 180px" maxLength="50" ></s:textfield>																										
								</td>
							</TR>
							<tr>
								<td rowspan=2>
