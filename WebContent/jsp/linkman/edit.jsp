...
<BODY>
<s:debug></s:debug>
	<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/linkman/editLinkMan.action" method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							 <tr>
								<td>所属客户：</td>
								<td colspan="3">
									<s:select name="customer.custId" list="customers" listKey="custId" listValue="custName" headerKey="" headerValue="--请选择--"  class='textbox' id='sChannel2' style="WIDTH: 180px" maxLength='50'></s:select>
								</td>
							</tr> 
							<TR>
								<td>联系人名称：</td>
								...
								<td>联系人性别：</td>
								<td>
									<input type="radio" value="1" name="lkmGender" ${lkmGender=="1"?"checked":""}>男
									<input type="radio" value="0" name="lkmGender" ${lkmGender=="0"?"checked":""}>女
								</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
							...
							<TR>
								<td>联系人简介 ：</td>
								<td colspan="2">
									<textarea class=textbox id=sChannel2 style="WIDTH: 180px"  name="lkmMemo" >${lkmMemo}</textarea>
								</td>
							</TR>
							<tr>
								<td rowspan=2>
