										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>																																																		
													...
													<td>联系人职位 ：</td>
													<td>
														<s:textfield class='textbox' id='sChannel2' style="WIDTH: 80px" maxLength='50' name="lkmPosition"></s:textfield>													
													</td>
													<td>所属客户：</td>
													<td colspan="3">
														<s:select name="customer.custId" list="customers" listKey="custId" listValue="custName" headerKey="" headerValue="--请选择--"  class='textbox' id='sChannel2' style="WIDTH: 80px" maxLength='50'></s:select>
													</td>
													<td>联系人性别：</td>
													<td>
